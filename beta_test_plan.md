...
- **Journey 1**: **New user installing the app** ✔️
...
- **Journey 6**: **Creating a new group** ✔️
...
- **Edge Case 2**: **Post deletion by unauthorized user** ✔️
