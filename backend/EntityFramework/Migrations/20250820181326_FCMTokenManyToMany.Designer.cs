...
namespace EntityFramework.Migrations
{
    ...
    [Migration("20250820181326_FCMTokenManyToMany")]
    partial class FCMTokenManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FCMDeviceUser", b =>
                {
                    b.Property<string>("FCMDevicesFCMToken")
                        .HasColumnType("text");

                    b.Property<Guid>("UsersId")
                        .HasColumnType("uuid");

                    b.HasKey("FCMDevicesFCMToken", "UsersId");

                    b.HasIndex("UsersId");

                    b.ToTable("UserFCMDevices", (string)null);
                });
            ...
            modelBuilder.Entity("FCMDeviceUser", b =>
                {
                    b.HasOne("EntityFramework.Models.FCMDevice", null)
                        .WithMany()
                        .HasForeignKey("FCMDevicesFCMToken")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
