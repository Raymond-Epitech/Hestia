...
import type { Reminder, User, Colocation, Chore, Coloc, Expenseget, Expense, UserBalance, ExpenseList, Expense_Modif, refund, shoppinglist, shoppinglist_item, expenses_category, expenses_category_get, message, UpdateChore, ReminderItem, Locale, Feedback } from "./type";
...
export class bridge {
    ...
    async addFeedback(data: Feedback): Promise<boolean> {
        try {
