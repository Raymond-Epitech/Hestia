          ...
          <form class="form-container" method="post" action="">
            <div>
              <div class="name-expense-container">
                <input class="name-input" maxlength="40" v-model="expense.name" :placeholder="$t('expense_name')"
                  required />
                <div class="expense-container">
                  <input class="expense-input" type="number" v-model="expense.amount" @input="filterNumericInput"
                    min="0" required />
                  <text>€</text>
                </div>
              </div>
