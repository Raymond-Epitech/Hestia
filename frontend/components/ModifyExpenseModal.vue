          ...
          <form class="form-container" method="post" action="">
            <div>
              <div class="name-expense-container">
                <input class="name-input" maxlength="40" v-model="modified_expense.name"
                  :placeholder="$t('expense_name')" required />
                ...
                <div class="checkbox-list">
                  <label v-for="coloc in list_coloc" :key="coloc.id" class="checkbox-item">
                    ...
                    <input type="number" class="split-value-input"
                      :value="modified_expense.splitBetween.includes(coloc.id) ? calculatedSplitValue : 0" readonly />
                  </label>
                </div>
              </div>
                ...
                <div class="checkbox-list">
                  <label v-for="coloc in list_coloc" :key="coloc.id" class="checkbox-item percentage">
                    ...
                    <div class="split-value-container">
                      <input type="number" class="split-value-input"
                        v-model.number="modified_expense.splitPercentages[coloc.id]" placeholder="0" min="0"
                        max="100" />
                      <span class="percentage-symbol">%</span>
                    </div>
                    <input type="number" class="split-value-input" :value="calculateValueFromPercentage(coloc.id)"
                      readonly />
                  </label>
                </div>
              </div> -->
